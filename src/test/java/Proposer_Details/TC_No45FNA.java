...
public class TC_No45FNA  extends BaseClass
{
   @Test
   public void CheckandverifyAnnualIncomeField()
   {	
	  ...
	  WebElement text = driver.findElement(By.xpath("//android.widget.EditText[contains(@text, 'Annual Income Enter details INR')]"));  
	  text.sendKeys("5600000");
